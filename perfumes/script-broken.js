// Unified Perfumes Script - Simple Version
document.addEventListener('DOMContentLoaded', function() {
    ...
    function initializeQuickView() {
        ...
        console.log('Quick view elements found:', {
            ...
            overlay: !!overlay,
            closeBtn: !!closeBtn
        }); Uncaught SyntaxError: Unexpected token ')' (at script.js?v=1757525092:265:18)Understand this error
reviews-manager.js:18 Reviews Manager initialized
related-products.js:18 Related Products Manager initialized
    ...
    function openQuickView(productId) {
        ...
        try {
            // Show the quickview sidebar
            const sidebar = document.getElementById('quick-view-sidebar');
            const overlay = document.getElementById('quick-view-overlay');
            
            if (sidebar) {
                sidebar.classList.add('active');
                console.log('Quickview sidebar shown');
            }
            if (overlay) {
            ...
            if (sizeSelection) {
                sizeSelection.innerHTML = `
                    ...
                    <div class="size-options-container">
                        <div class="size-option selected" data-size="30ml">30ml</div>
                        <div class="size-option" data-size="50ml">50ml</div>
                        <div class="size-option" data-size="100ml">100ml</div>
                        <div class="size-option" data-size="200ml">200ml</div>
                    </div>
                `;
                ...
                sizeSelection.querySelectorAll('.size-option').forEach(option => {
                    option.addEventListener('click', function() {
                        sizeSelection.querySelectorAll('.size-option').forEach(opt => opt.classList.remove('selected'));
            ...
            console.log('Quickview loaded successfully');

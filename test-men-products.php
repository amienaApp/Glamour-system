...
echo "=== MEN'S CLOTHING PRODUCTS ANALYSIS ===\n\n";
...
try {
    ...
    if (count($allProducts) === 0) {
        echo "❌ No men's clothing products found in database!\n";
        echo "   Please add some men's clothing products first.\n";
        exit;
    }
    ...
    echo "✅ Men's clothing analysis completed!\n";

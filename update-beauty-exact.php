<?php
// Update Beauty & Cosmetics with the exact subcategories that were working before
error_reporting(E_ALL);
ini_set('display_errors', 1);

echo "<h1>Update Beauty & Cosmetics with Original Subcategories</h1>";
...
try {
    ...
    if ($beautyCategory) {
        ...
        // Use the exact subcategories from the original setup
        $beautySubcategories = [
            'Makeup',
            'Skincare', 
            'Hair',
        ...
        echo "<h2>Adding the original subcategories to Beauty & Cosmetics:</h2>";
        echo "<ul>";
        ...
        if ($result->getModifiedCount() > 0) {
            echo "<p>✅ Successfully updated Beauty & Cosmetics category with original subcategories!</p>";

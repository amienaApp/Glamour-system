...
echo "=== PERFUMES PRODUCTS ANALYSIS ===\n\n";
...
try {
    ...
    if (count($allProducts) === 0) {
        echo "❌ No perfumes products found in database!\n";
        echo "   Please add some perfumes products first.\n";
        exit;
    }
    ...
    echo "✅ Perfumes analysis completed!\n";

...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function openQuickView(productId) {
        ...
        // Initially disable the add to bag button
        const addToBagBtn = document.getElementById('add-to-bag-quick');
        if (addToBagBtn) {
            addToBagBtn.disabled = true;
            addToBagBtn.textContent = 'Please select a color';
    ...
    function selectQuickViewColor(color) {
        // Update button state based on color selection
        const addToBagBtn = document.getElementById('add-to-bag-quick');
        if (addToBagBtn) {
            if (color) {

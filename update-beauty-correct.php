<?php
// Update Beauty & Cosmetics with the correct subcategories from Category model
error_reporting(E_ALL);
ini_set('display_errors', 1);

echo "<h1>Update Beauty & Cosmetics with Correct Subcategories</h1>";
...
try {
    ...
    if ($beautyCategory) {
        ...
        // Use the exact subcategories from the Category model
        $beautySubcategories = [
            'Makeup',
            'Skincare', 
            'Hair',
        ...
        echo "<h2>Adding the correct subcategories from Category model:</h2>";
        echo "<ul>";
        ...
        if ($result->getModifiedCount() > 0) {
            echo "<p>✅ Successfully updated Beauty & Cosmetics category with correct subcategories!</p>";

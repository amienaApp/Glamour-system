    ...
    function openQuickView(productId) {
        ...
        if (sizeSelection) {
            ...
            if (sizes.length === 0) {
                ...
                // Add regular clothing sizes as fallback for products without sizes
                sizes = ['S', 'M', 'L', 'XL'];
                selectedQuickViewSize = 'M'; // Set default fallback size to Medium
            }
            ...
            // Create size action buttons (only for multi-size products)
            if (sizes.length > 1) {
            ...
            sizes.forEach(size => {
                ...
                // No special styling needed for regular sizes

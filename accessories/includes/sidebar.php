        ...
        <div class="filter-group">
            ...
            <div class="filter-options" id="category-filter">
                ...
                <?php else: ?>
                    ...
                    <label class="filter-option">
                        <input type="checkbox" name="category[]" value="Watches" onchange="filterByCategory('Watches', this.checked)">
                        <span class="checkmark"></span>
                        Watches
                    </label>
                    <label class="filter-option">
                        <input type="checkbox" name="category[]" value="Sunglasses" onchange="filterByCategory('Sunglasses', this.checked)">
                        <span class="checkmark"></span>
                        Sunglasses
                    </label>
                    <label class="filter-option">
                        <input type="checkbox" name="category[]" value="Jewelry" onchange="filterByCategory('Jewelry', this.checked)">
                        <span class="checkmark"></span>
                        Jewelry
                    </label>
                    <label class="filter-option">
                        <input type="checkbox" name="category[]" value="Belts" onchange="filterByCategory('Belts', this.checked)">
                        <span class="checkmark"></span>
                        Belts
                    </label>
                <?php endif; ?>

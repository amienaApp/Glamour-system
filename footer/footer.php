<?php
// Footer include file for Glamour Palace
?>
...
<footer class="custom-footer">
    <div class="footer-container">
        ...
        <div class="footer-col">
            ...
            From chic outfits and timeless accessories to fragrances and home décor, we bring you curated collections that inspire confidence, style, and elegance. At Glamor, shopping is more than a purchase—it's an experience of living beautifully, every day.
            </p>
        </div>
        <div class="footer-col">

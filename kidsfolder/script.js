// Unified Kids' Fashion Script
document.addEventListener('DOMContentLoaded', function() {
    // Kids script loaded successfully
    ...
    function openQuickView(productId) {
        ...
        if (sizeSelection) {
            ...
            // If still no sizes, use kids' clothing sizes as fallback
            if (sizes.length === 0) {
                console.log('No sizes found for this product - using kids\' clothing sizes');
                // Use kids' clothing sizes: 2T, 3T, 4T, 5T, 6, 7, 8, 10, 12, 14
                sizes = ['2T', '3T', '4T', '5T', '6', '7', '8', '10', '12', '14'];
                selectedQuickViewSize = '6'; // Set default size
            }

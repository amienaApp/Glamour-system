...
document.addEventListener('DOMContentLoaded', function() {
    console.log('Kids script loaded successfully');
    ...
    function openQuickView(productId) {
        ...
        if (sizeSelection) {
            ...
            // If still no sizes, use kids-specific sizes as fallback
            if (sizes.length === 0) {
                console.log('No sizes found for this product - using kids-specific sizes');
                // Use kids-specific sizes: Infant (0M-24M), Toddler (2T-4T), Children (4Y-14Y)
                sizes = ['0M', '3M', '6M', '9M', '12M', '18M', '24M', '2T', '3T', '4T', '4Y', '5Y', '6Y', '7Y', '8Y', '10Y', '12Y', '14Y'];
                selectedQuickViewSize = '6Y'; // Set default size
            }
    ...
    // Initialize quickview wishlist button

            ...
            <div class="form-group" id="size_selection_group" style="display: none;">
                ...
                <div class="form-section">
                    ...
                    <div class="image-upload-section">
                        <h3><i class="fas fa-upload"></i> Upload Product Images</h3>
                        <p>Add front and back images for your product</p>
                        <div class="image-inputs">
                            <div class="image-input-group">
                                <label for="front_image">Front Image *</label>
                                <input type="file" id="front_image" name="front_image" accept="image/*" required onchange="previewImage(this, 'front-preview')">
                            ...
                            <div class="image-input-group">
                                ...
                                <input type="file" id="back_image" name="back_image" accept="image/*" required onchange="previewImage(this, 'back-preview')">
                ...
                <div class="variant-item">
                    ...
                    <div class="variant-image-inputs">
                        <div class="image-input-group">
                            ...
                            <input type="file" name="color_variants[${colorVariantIndex}][front_image]" accept="image/*" onchange="previewVariantImage(this, 'variant-front-${colorVariantIndex}')">
                        ...
                        <div class="image-input-group">
                            ...
                            <input type="file" name="color_variants[${colorVariantIndex}][back_image]" accept="image/*" onchange="previewVariantImage(this, 'variant-back-${colorVariantIndex}')">

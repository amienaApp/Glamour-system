...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Product data for quick view - Bags
    const productData = {
        1: {
            ...
            images: [
                { src: "../img/bags/womenbags/sh1.webp", color: "black" },
                { src: "../img/bags/womenbags/sh1.0.jpg", color: "black" },
            ],
            colors: [
            ...
            capacity: "Fits phone, wallet, keys",
        ...
        2: {
            ...
            category: "totebag",
            images: [
                { src: "../img/bags/womenbags/totebags/1.jpg", color: "black" }
            ...
            capacity: "Fits laptop, books, essentials",
        ...
        3: {
            ...
            category: "shoulderbag",
            images: [
                { src: "../img/bags/womenbags/sh2.avif", color: "black" },
                { src: "../img/bags/womenbags/sh2.1.avif", color: "silver" }
            ],
            colors: [
                { name: "Black", value: "black", hex: "#000" },
            ...
            capacity: "Fits essentials and small items",
            style: "Modern & Trendy"
        },
        4: {
            ...
            brand: "Fashion Brand",
            gender: "women",
            category: "clutchesbag",
            images: [
                { src: "../img/bags/womenbags/cluthesbags/4.jpeg", color: "black" },
                { src: "../img/bags/womenbags/cluthesbags/4.0.jpeg", color: "black" }
            ],
            colors: [
                { name: "Black", value: "black", hex: "#000" }
            ],
            ...
            capacity: "Fits phone, keys, small wallet",
        ...
        5: {
            ...
            category: "backpacks",
            images: [
                { src: "../img/bags/menbags/backpacks/1.jpeg", color: "black" },
                {src: "../img/bags/menbags/backpacks/1.0.jpeg", color: "black" }
            ],
            colors: [
                { name: "Black", value: "black", hex: "#000" }
        ...
        6: {
            ...
            brand: "Casual Brand",
            gender: "women",
            category: "crossbodybag",
            images: [
                { src: "../img/bags/womenbags/crossbodybags/1.jpg", color: "brown" },
            ],
            colors: [
            ...
            capacity: "Fits phone, wallet, small items",
        ...
        7: {
            ...
            category: "clutchesbag",
            images: [
                { src: "../img/bags/menbags/crossbodybags/1.webp", color: "black" }
            ],
            colors: [
                { name: "Brown", value: "black", hex: "#000000ff" }
               
            ],
            sizes: ["mini", "small"],
            material: "Satin & Embellishments",
            dimensions: "9\" x 5\" x 1\"",
            capacity: "Fits phone, lipstick, keys",
        ...
        8: {
            ...
            category: "briefcases",
            images: [
                { src: "../img/bags/menbags/briefcases/2.jpeg", color: "black" },
                { src: "../img/bags/menbags/briefcases/2.0.jpeg", color: "black" }
            ],
            colors: [
                { name: "Black", value: "black", hex: "#000" },
            ...
            capacity: "Fits laptop, documents, accessories",
            style: "Professional & Business"
        },
        9: {
            name: "women backpack Bag",
            price: "$160",
            brand: "Tech Brand",
            gender: "women",
            category: "laptopbags",
            images: [
                { src: "../img/bags/womenbags/backpacks/1.jpeg", color: "brown" }
            ],
            colors: [
            ...
            capacity: "Fits up to 15\" laptop",
            style: "Professional & Practical"
        },
        10: {
            name: "Sporty Waist Bag",
            price: "$60",
            brand: "Sports Brand",
            gender: "women",
            category: "waistbags",
            images: [
                { src: "../img/bags/womenbags/waistbags/1.0.jpeg", color: "pink" },
                { src: "../img/bags/womenbags/waistbags/1.jpeg", color: "pink" }

            ],
            colors: [
                { name: "Pink", value: "pink", hex: "#d186b2ff" }
            ],
            sizes: ["mini", "small"],
            material: "Waterproof Polyester",
            dimensions: "8\" x 4\" x 2\"",
            capacity: "Fits phone, keys, small items",
            style: "Sporty & Active"
        },
        11: {
            name: "Leather Wallet",
            ...
            category: "wallets",
            images: [
                { src: "../img/bags/womenbags/wallets/1.0.jpeg", color: "black" },
                { src: "../img/bags/womenbags/wallets/1.jpeg", color: "black" },
            ...
            capacity: "Fits cards, cash, coins",
        ...
        12: {
            ...
            category: "waistbags",
            images: [
                { src: "../img/bags/menbags/waistbags/1.0.jpeg", color: "black" },
                { src: "../img/bags/menbags/waistbags/1.jpeg", color: "black" }

...
// Extract all unique colors from ALL bags products for dynamic color filter
require_once '../models/Product.php';
$productModel = new Product();
$allBagsProducts = $productModel->getByCategory("Bags");
$allColors = [];

foreach ($allBagsProducts as $product) {
...
error_log('Bags dynamic colors found: ' . json_encode($allColors));
?>
<!DOCTYPE html>
<html lang="en">
<head>
